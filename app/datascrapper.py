...
class NewsScraper:
    def __init__(self, base_url, total_pages, db_url='sqlite:///news_database.db'):
    ...
    def save_to_db(self, title, tag):
        current_date = datetime.now()
        session = self.Session()
        news_article = NewsArticle(title=title, date=current_date, tag=tag)
...
base_url = "https://www.mubasher.info/markets/TDWL/stocks/4190/news/"
total_pages = 1
